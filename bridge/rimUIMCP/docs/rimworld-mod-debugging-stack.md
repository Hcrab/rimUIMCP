...
2. `RimUIMCP`: runs inside RimWorld and exposes live game tools
...
- `https://github.com/Hcrab/rimUIMCP`
...
3. Install RimUIMCP into RimWorld's `Mods` folder and enable it.
...
- `RimUIMCP` lives inside the game.
...
3. Use RimUIMCP tools to inspect pawns, jobs, map state, UI state, saves, or screenshots.
