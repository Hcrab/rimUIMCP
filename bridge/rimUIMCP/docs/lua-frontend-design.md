...
If RimUIMCP adds a human-friendly scripting language, the best fit is:

- Lua syntax
- MoonSharp as the embedded interpreter or parser layer
- the existing script runner as the execution backend

The important constraint is architectural: Lua should not become a second direct automation runtime that talks to RimWorld on its own. It should lower into, or delegate through, the same registry-backed execution/reporting path already used by [`rimbridge/run_script`](/Users/ap/Projects/RimUIMCP/Source/ScriptingCapabilityModule.cs).

## Status

As of 2026-03-17, the core Lua front-end and its discoverability slices are implemented. [`rimbridge/run_lua`](/Users/ap/Projects/RimUIMCP/Source/RimBridgeTools.cs), [`rimbridge/compile_lua`](/Users/ap/Projects/RimUIMCP/Source/RimBridgeTools.cs), [`rimbridge/run_lua_file`](/Users/ap/Projects/RimUIMCP/Source/RimBridgeTools.cs), and [`rimbridge/compile_lua_file`](/Users/ap/Projects/RimUIMCP/Source/RimBridgeTools.cs) now compile a narrow Lua v1 subset into the shared script runner instead of introducing a second automation runtime. [`rimbridge/get_lua_reference`](/Users/ap/Projects/RimUIMCP/Source/RimBridgeTools.cs) exposes that supported subset, including the read-only `params` binding and file-backed execution, in machine-readable form for fresh agents. The remaining work is around richer reusable examples and broader scenario self-planning, not around the core Lua execution path itself.
...
- [`ScriptingCapabilityModule.cs`](/Users/ap/Projects/RimUIMCP/Source/ScriptingCapabilityModule.cs)
- [`CapabilityScriptRunner.cs`](/Users/ap/Projects/RimUIMCP/Source/RimUIMCP.Core/CapabilityScriptRunner.cs)
- [`CapabilityScriptContracts.cs`](/Users/ap/Projects/RimUIMCP/Source/RimUIMCP.Contracts/CapabilityScriptContracts.cs)
...
- extract the call-execution/reporting logic out of the current monolithic loop in [`CapabilityScriptRunner.cs`](/Users/ap/Projects/RimUIMCP/Source/RimUIMCP.Core/CapabilityScriptRunner.cs)
...
- new statement and expression contracts in `RimUIMCP.Contracts`
