...
internal static class SmokeScenarioCatalog
{
    ...
    private const string RimBridgePackageId = "brrainz.rimuimcp";
    private const string RimBridgeSteamPackageId = "brrainz.rimuimcp_steam";
    ...
    private static async Task RunModConfigurationRoundTripAsync(SmokeScenarioContext context, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var targetMod = ResolvePreferredActiveNonCoreMod(initialActiveMods, "brrainz.rimuimcp");
