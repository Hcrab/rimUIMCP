...
public class OperationRunnerTests
{
    ...
    public void ConvertsSdkAbiExceptionsIntoActionableFailedOperationEnvelopes()
    {
        ...
        var envelope = runner.Run(
            () => throw new MissingMethodException("Method not found: RimUIMCP.Sdk.IRimBridgeToolClient.CallAsync"),
        ...
        Assert.Contains("Rebuild/redeploy RimUIMCP and the companion mod", envelope.Error.Message);
    }
