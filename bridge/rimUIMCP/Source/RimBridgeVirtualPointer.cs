...
internal static class RimBridgeVirtualPointer
{
        ...
        bool clearOnRealInput = true)
    {
        ...
        lock (Sync)
        {
            _persistentPointer = new PointerState
            {
                ...
                ExpiresAtUtc = kind == "ui-input" ? DateTime.MaxValue : createdAtUtc.AddMilliseconds(normalizedDurationMs),
    ...
    public static void ApplyLateInputPatches()
    {
        lock (LatePatchSync)
        {
            ...
            var harmony = new Harmony("pardeike.rimuimcp.virtual-input-late");
