...
public sealed class RimBridgeNotReadyException : InvalidOperationException
{
    public RimBridgeNotReadyException()
        : base("RimUIMCP SDK host is not ready. Use the SDK from inside a RimBridge companion tool invocation, or wait until RimUIMCP has completed companion registration.")
    {
    }
}
