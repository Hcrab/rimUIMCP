...
public class RimBridgeTools
{
    ...
    [ReadmeTool("Debug Actions And Mods", "Set RimWorld's current time speed directly; RimUIMCP enables the boost for speed 4 (Ultrafast) at startup, and this tool can change that state")]
    [Tool("rimworld/set_time_speed", Description = "Set RimWorld's current time speed directly; RimUIMCP enables the boost for speed 4 (Ultrafast) at startup, and this tool can change that state")]
    public object SetTimeSpeed(
        ...
        [ToolParameter(Description = "When set, change RimWorld's private TickManager.UltraSpeedBoost flag. RimUIMCP enables it at startup; leave null to preserve the current value.")] bool? ultraSpeedBoost = null)
    {
    ...
    [ReadmeTool("Camera And Screenshots", "Enable or disable RimUIMCP's session-only extended camera zoom range; disabled by default")]
    [Tool("rimworld/set_camera_zoom_extension", Description = "Enable or disable RimUIMCP's session-only extended camera zoom range; disabled by default")]
